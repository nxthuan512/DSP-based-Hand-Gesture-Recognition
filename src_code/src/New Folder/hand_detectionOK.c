			...
			for(wx = xmin; wx < xmax - w; wx += Scale)
			{
				...
				for(i_stage = 0; i_stage < 20; i_stage++)
				{
					...
					for(i_trees = 0; i_trees < stageOK[i_stage]; i_trees++)
					{
						...
						{
							RectX = RectxOK[curr_feature_index]*Scale + wx;
							RectY = RectyOK[curr_feature_index]*Scale + wy;
							RectW = RectwOK[curr_feature_index]*Scale;
							RectH = RecthOK[curr_feature_index]*Scale;
