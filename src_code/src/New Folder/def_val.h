...
// Haar Cascade
//A
extern unsigned char ScaleA[6];
extern unsigned short Window_WA[6];
extern unsigned short Window_HA[6];
extern unsigned short normalizeA[6];
...
//5
extern unsigned char Scale5[6];
extern unsigned short Window_W5[6];
extern unsigned short Window_H5[6];
extern unsigned short normalize5[6];
...
//B
extern unsigned char ScaleB[6];
extern unsigned short Window_WB[6];
extern unsigned short Window_HB[6];
extern unsigned short normalizeB[6];
...
//OK
extern unsigned char ScaleOK[6];
extern unsigned short Window_WOK[6];
extern unsigned short Window_HOK[6];
extern unsigned short normalizeOK[6];
