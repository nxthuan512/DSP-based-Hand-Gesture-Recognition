			...
			for(wx = xmin; wx < xmax - w; wx += Scale)
			{
				...
				for(i_stage = 0; i_stage < 20; i_stage++)
				{
					...
					for(i_trees = 0; i_trees < stageB[i_stage]; i_trees++)
					{
						...
						{
							RectX = RectxB[curr_feature_index]*Scale + wx;
							RectY = RectyB[curr_feature_index]*Scale + wy;
							RectW = RectwB[curr_feature_index]*Scale;
							RectH = RecthB[curr_feature_index]*Scale;
