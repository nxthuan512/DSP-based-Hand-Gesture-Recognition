			...
			for(wx = xmin; wx < xmax - w; wx += Scale)
			{
				...
				for(i_stage = 0; i_stage < 20; i_stage++)
				{
					...
					for(i_trees = 0; i_trees < stage5[i_stage]; i_trees++)
					{
						...
						{
							RectX = Rectx5[curr_feature_index]*Scale + wx;
							RectY = Recty5[curr_feature_index]*Scale + wy;
							RectW = Rectw5[curr_feature_index]*Scale;
							RectH = Recth5[curr_feature_index]*Scale;
